  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved phone as @phone" do
        post :create, {:phone => invalid_attributes}, valid_session
        expect(assigns(:phone)).to be_a_new(Phone)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested phone" do
        phone = Phone.create! valid_attributes
        put :update, {:id => phone.to_param, :phone => new_attributes}, valid_session
        phone.reload
    ...
    context "with invalid params" do
      it "assigns the phone as @phone" do
        phone = Phone.create! valid_attributes
        put :update, {:id => phone.to_param, :phone => invalid_attributes}, valid_session
        expect(assigns(:phone)).to eq(phone)
      end
