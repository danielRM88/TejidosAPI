...
FactoryGirl.define do
  factory :client, class: Api::V1::Client do
  ...
  factory :client2, class: Api::V1::Client do
  ...
  factory :client3, class: Api::V1::Client do
  ...
  factory :client4, class: Api::V1::Client do
