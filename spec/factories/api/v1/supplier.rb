...
FactoryGirl.define do
  factory :supplier, class: Api::V1::Supplier do
  ...
  factory :supplier2, class: Api::V1::Supplier do
  ...
  factory :supplier3, class: Api::V1::Supplier do
  ...
  factory :supplier4, class: Api::V1::Supplier do
  ...
  factory :supplier5, class: Api::V1::Supplier do
  ...
  factory :supplier6, class: Api::V1::Supplier do
